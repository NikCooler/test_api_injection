...
<div class="outerWrapper">
    ...
    <div class="innerWrapperEmpl">
        ...
        <form class="formEmpl" method="POST" action="addEmployee" onsubmit="return validateEployee()">
            ...
            <p><input type="text" id="dateOfBirth" name="dateOfBirth"  value="${employee.dateOfBirth}"/>
