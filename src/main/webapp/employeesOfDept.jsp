...
<div class="tableWrapper">
    <h2>Employees of the Department</h2>
    <display:table name="employeeList" id="employee">
        ...
        <display:column title="Action">
            ...
            <a href="<c:url value="/deleteEmployee?employeeId=${employee.employeeId}&departmentId=${employee.department.departmentId}&command=employeesOfDept"/>">Delete</a>
            <a href="<c:url value="/updateEmployee?employeeId=${employee.employeeId}&departmentId=${employee.department.departmentId}&command=employeesOfDept"/>">Update</a>

        </display:column>
    </display:table>
    <div class="sub"><a href="<c:url value="/addEmployee?command=employeesOfDept"/>"><input type="submit" value="Add Employee"></a></div>
</div>
</body>
</html>